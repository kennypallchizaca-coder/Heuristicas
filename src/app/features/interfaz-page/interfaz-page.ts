...
export class InterfazPage {
  heuristicas: Heuristica[] = [
    ...
    },
    {
      ...
      icono: '🎨',
      descripcion:
        'No incluir información irrelevante que compita con el contenido importante.',
      ruta: '/heuristica/8',
    },
    {
      id: 9,
    ...
    },
    {
      ...
      icono: '📚',
      descripcion:
        'Proporcionar ayuda fácil de buscar, enfocada en las tareas reales del usuario.',
      ruta: '/heuristica/10',
    },
  ];
}
